...
This was just the jumping off point. After the website was live, I started several other subcontracts to build [(and rebuild)](./childhood-cancer-rewrite) program websites for the U.P. Lions. My newest venture has been the development of the UPLS CMS, a custom CMS built on top of PayloadCMS that will allow the U.P. Lions to manage their own content without having to go through me. I'll be detailing that in a future post.
