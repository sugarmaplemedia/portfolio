...
postTitle: "Making a website for America's largest Finnish Heritage organization"
pubDate: "2023-01-18"
...
<Gallery
	pictures={[
		{
			src: "/images/portfolio/finlandia-foundation/contenttransfer-fullmap.png",
			alt: "Full map of site transfer",
			caption: "Full map of site transfer",
		},
		{
			src: "/images/portfolio/finlandia-foundation/contenttransfer-newmap.png",
			alt: "Map of new site pages",
			caption: "Map of new site pages",
		},
	]}
	client:idle
/>
...
<Gallery
	pictures={[
		{
			src: "/images/portfolio/finlandia-foundation/websitelayout-home.jpg",
			alt: "Home page",
			caption: "Home page",
		},
		{
			src: "/images/portfolio/finlandia-foundation/websitelayout-scholarships.png",
			alt: "Scholarships Program page",
			caption: "Scholarships Program page",
		},
		{
			src: "/images/portfolio/finlandia-foundation/websitelayout-news.png",
			alt: "E-News and Newsletter Archive page",
			caption: "E-News and Newsletter Archive page",
		},
	]}
	client:idle
/>
...
<Gallery
	pictures={[
		{
			src: "/images/portfolio/finlandia-foundation/workspace-services.png",
			alt: "Google workspace services list",
			caption: "Is all of this really necessary, Google?",
		},
	]}
	client:idle
/>
